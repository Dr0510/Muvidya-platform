        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16 py-20 md:py-28 lg:py-32">
          ...
          <AnimatedSection delay={600} direction="scale" className="hidden lg:block">
            <div className="relative">
              ...
              <div className="relative rounded-[2rem] border border-border/40 bg-surface/50 p-3 shadow-2xl shadow-primary/10 backdrop-blur-xl">
                <div className="relative aspect-square sm:aspect-[4/3] rounded-xl overflow-hidden bg-muted/50">
                  <Image
                  ...
                  {/* Badge overlay */}
                  <div className="absolute top-3 left-3 inline-flex items-center gap-2 rounded-full bg-white/90 backdrop-blur-sm px-3 py-1.5 text-xs sm:text-sm font-semibold text-gray-900 shadow-sm">
                  ...
                  <div className="absolute bottom-3 left-3 right-3 flex flex-wrap gap-2">
                    {["Robotics", "Coding", "AI/ML", "IoT"].map((item) => (
                      <span
                        key={item}
                        className="rounded-md bg-white/90 backdrop-blur-sm px-2 py-1 text-[10px] sm:text-xs font-semibold text-gray-700 shadow-sm"
                      >
                        {item}
                      </span>
                    ))}
